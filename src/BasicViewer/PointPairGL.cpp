...
namespace MapCreator {
	...
	void PointPairGL::SetupData ( ) {
		...
		data_[ 0 ].color = glm::vec3 ( 1.0f , 0.0f , 1.0f );
		data_[ 1 ].color = glm::vec3 ( 0.8f , 0.2f , 0.8f );
	...
	AnswerPointPairGL::AnswerPointPairGL ( QOpenGLFunctions_4_1_Core * GL , const std::pair < glm::vec3 , glm::vec3 > & point_pair ) :
			PointPairGL ( GL , point_pair ) { }

	void AnswerPointPairGL::SetupData ( ) {
		...
		data_[ 0 ].color = glm::vec3 ( 0.0f , 1.0f , 0.0f );
		data_[ 1 ].color = glm::vec3 ( 0.2f , 0.8f , 0.2f );
		data_[ 2 ].color = glm::vec3 ( 1.0f , 1.0f , 1.0f );
